...
export default function Home() {
  ...
  async function downloadCardAsImage() {
    ...
    try {
      ...
      // 1) iOS / Android moderno → Share Sheet (GUARDAR IMAGEN)
      ...
      // 2) Desktop / Android → descarga directa
      ...
      // 3) Fallback iPhone → abrir imagen para guardarla manual
  ...
  return (
    <main className="max-w-3xl mx-auto p-4 text-black font-sans">
      ...
      <section className="mb-6">
        ...
        {/* SOLO ESTA CAJA SE GUARDA COMO IMAGEN */}
        ...
        <div className="text-xs text-gray-600 mt-2">
          En iPhone puede abrirse la imagen para guardarla en Fotos.
        </div>
      </section>
